...
cases =
  ...
  , Case {description = "char", regex = Sym False 'a', sample = "a", result = True}
  , Case
      {description = "not char", regex = Sym False 'a', sample = "b", result = False}
  , Case
  ...
  , Case
      ...
      , regex = Alt (Sym False 'a') (Sym False 'b')
      , sample = "a"
      , result = True
      }
  , Case
  ...
  , Case
      ...
      , regex = Seq (Sym False 'a') (Sym False 'b')
      , sample = "ab"
      , result = True
      }
  , Case
